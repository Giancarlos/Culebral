...
public static class BuiltinSymbols
{
    public static SymbolScope CreateGlobalScope()
    {
        ...
        DeclareFunction(scope, "type", [PrimitiveType.Object], PrimitiveType.Object);
    ...
    private static void DeclareType(SymbolScope scope, string name, SkelvonType type)
    {
    ...
    private static void DeclareFunction(SymbolScope scope, string name, SkelvonType[] paramTypes, SkelvonType returnType)
    {
        scope.TryDeclare(new Symbol
        {
            Name = name,
